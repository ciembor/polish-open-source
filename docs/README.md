...
- [Publication](publication.md): public snapshot rules, historical metric semantics, and publication rollback.
- [Performance](performance.md): load profile, SLOs, query-plan checks, and spike response.
- [Operations Runbook](operations-runbook.md): Sentry setup, incident handling, restarts, and backup restore steps.
