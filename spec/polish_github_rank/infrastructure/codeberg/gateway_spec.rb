...
class FakeCodebergClient
  ...
  def queue(body:)
    @responses << PolishGithubRank::Infrastructure::CodebergClient::Response.new(
      status: 200,
      headers: {},
      body: body
    )
...
RSpec.describe PolishGithubRank::Infrastructure::CodebergGateway do
  ...
  it 'translates missing users to the source contract error' do
    client.queue_error(PolishGithubRank::Infrastructure::CodebergClient::NotFound.new('missing',
                                                                                      status: 404,
                                                                                      body: '{}'))
